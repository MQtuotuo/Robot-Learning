...
public class GridWorld {
    ...
    public static enum Move {LEFT, RIGHT, DOWN, UP, DIAG_LEFT_DOWN, DIAG_LEFT_UP, DIAG_RIGHT_DOWN, DIAG_RIGHT_UP};
    ...
    public GridWorld(double[] prob){
        ...
        rewardGrid[1][6] = -500; 
        rewardGrid[2][1] = -500; rewardGrid[2][4] = -500; rewardGrid[2][5] = -500; rewardGrid[2][6] = 1000; 
        rewardGrid[3][1] = -500; rewardGrid[3][2] = -500;
        rewardGrid[4][1] = -500; rewardGrid[4][2] = -500; rewardGrid[4][3] = -500; rewardGrid[4][4] = -500; rewardGrid[4][5] = -500;
        }
